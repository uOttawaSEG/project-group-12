...
This course does not focus on user interface design. However, students are encouraged to produce aesthetic user interfaces that are easy to use. Consider the [Android Design Guidelines](https://developer.android.com/design) when designing your application.


## ✨ **Features**

### **[Heading]**
- Talk about features of the app in these bullet points
...
- Talk about deliverable tasks that were implemented
...
## Screenshots
> Home screen
<img width="500" alt="Placeholder image" src="https://placehold.co/600x400?text=Coming+Soon" />
